              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold">Facial Only</p>
                    <p className="text-xs text-gray-500">Expression Analysis</p>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold">Voice Only</p>
                    <p className="text-xs text-gray-500">Tone Analysis</p>
                  </button>
                </div>
              </div>

              <div className="mb-6">
                <div className="w-full h-80 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center relative overflow-hidden">
                  {isScanning ? (
                    <>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-gray-500">Ready for {scanMode} scan</p>
                    </div>
                  )}
                </div>
              </div>
